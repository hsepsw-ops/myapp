    ...
    <div class="shell">
        ...
        <section class="history-panel">
            <div class="history-header">
                ...
                <span>{{ count($history) }} laporan tersimpan</span>
            </div>
            @if(count($history) === 0)
                        ...
                        <tbody>
                            @foreach($history as $index => $report)
                                <tr>
                                    ...
                                    <td>{{ $report['yang_dikawal'] }}</td>
                                    <td>{{ $report['rute_pengawalan'] }}</td>
                                    <td>{{ $report['evidence'] }}</td>
                                    <td>{{ $report['created_at'] }}</td>
                                    <td>
                                        <div class="action-buttons">
                                            <a class="table-button button-edit" href="/hse/pengawalan/{{ $index }}/edit">Edit</a>
                                            <a class="table-button button-print" href="/hse/pengawalan/{{ $index }}/print" target="_blank">Cetak</a>
                                        </div>
                                    </td>
                                </tr>
                            @endforeach
